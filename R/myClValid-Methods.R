...
setMethod("clusterMethods",signature(object="myClValid"),
...
setMethod("measures",signature(object="myClValid"),
...
setMethod("plot",c("myClValid","missing"),
...
setMethod("optimalScores", signature(object="myClValid"),
          function(object,measures=measNames(object)) {
